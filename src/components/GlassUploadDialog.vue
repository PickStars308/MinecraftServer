    ...
    <div v-if="visible" class="glass-dialog-overlay" @click.self="handleClose">
      <div class="glass-dialog" @click.stop>
        ...
        <div class="dialog-content">
          ...
          >
            ...
            <div class="upload-content">
              ...
              <p class="upload-hint">支持 JPG / PNG / GIF / WebP，单张 ≤ 10MB</p>
            </div>
          </div>
          ...
          <div v-if="selectedFiles.length" class="file-list">
            ...
            <div class="file-items">
              <div v-for="(file, index) in selectedFiles" :key="index" class="file-item">
                ...
                <button :disabled="isUploading" class="file-remove" @click="removeFile(index)">
        ...
        <div class="dialog-footer">
          ...
          <button :disabled="selectedFiles.length === 0 || isUploading" class="dialog-btn confirm"
                  @click="handleUpload">
...
const handleUpload = async () => {
  ...
  try {
    ...
    if (response.success) {
      addToast(response.message || '上传成功', 'success')
    ...
    addToast(error.message || '上传失败，请重试', 'error')
...
html[data-theme='dark'] .file-list-title,
...
html[data-theme='dark'] .file-items {
  &::-webkit-scrollbar-track {
